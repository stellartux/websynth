...
export class Note {
  ...
  /** @type {GainNode} */ envGain
  attack
  decay
  sustain
  release
  velocity
  /** @type {number} */ triggerTime
  oscs = []
   ...
   * @param {number} [noteParams.sustain=0.4] sustain level as proportion of peak level, 0 to 1 inclusive
  ...
  constructor(target, noteParams = {}) {
    ...
    this.sustain = noteParams.sustain || 0.4
